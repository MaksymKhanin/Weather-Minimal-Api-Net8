...
public sealed class Weather : ValueObject
{
    ...
    public WeatherName Name { get; private init; }
    public string Description { get; private init; }
    public string? Recommendation { get; private init; }

    private Weather(double temperature, WindDirection windDirection, double windSpeed, WeatherName name, string description, string? recommendation) =>
    ...
    internal static Result<Weather> Create(double temperature, WindDirection windDirection, double windSpeed, WeatherName name, string description, string? recommendation)
    {
